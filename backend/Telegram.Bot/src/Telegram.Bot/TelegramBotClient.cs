...
namespace Telegram.Bot
{
    ...
    public class TelegramBotClient : ITelegramBotClient
    {
        ...
        /// <param name="baseUrl">Used to change base url to your private bot api server URL. It looks like http://localhost:8081</param>
...
#pragma warning restore AsyncFixer03 // Avoid fire & forget async void methods
        ...
        public Task DeleteWebhookAsync(
            ...
            => MakeRequestAsync(new DeleteWebhookRequest() {DropPendingUpdates = dropPendingUpdates},
                cancellationToken);
...
#pragma warning restore 4014
        ...
        public Task UnbanChatMemberAsync(
            ...
            MakeRequestAsync(new UnbanChatMemberRequest(chatId, userId) {OnlyIfBanned = onlyIfBanned},
                cancellationToken);
