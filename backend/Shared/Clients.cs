    ...
    public class Clients
    {
        public static IEnumerable<Client> Get()
        {
            return new List<Client>
            {
                ...
                {
                    ClientId = "adminka",
                    ClientSecrets = {new Secret("ceeheiF0chai2ae2".Sha256())},

                    AllowedScopes =
                    {
                        "adminka_security", IdentityServerConstants.StandardScopes.OpenId,
                    },
                ...
                {
                    ClientId = "front",
                    ClientSecrets = {new Secret("Urooyu7IeDeikais".Sha256())},

                    AllowedScopes =
                    {
                        "trade", "profile_security", IdentityServerConstants.StandardScopes.OpenId,
                ...
                new Client
                {
                    ...
                    AllowedScopes =
                    {
                        "trade", IdentityServerConstants.StandardScopes.OpenId,
                        IdentityServerConstants.StandardScopes.Profile
                    },

                    AllowedGrantTypes = GrantTypes.ClientCredentials,
                    AllowAccessTokensViaBrowser = false,
                    AccessTokenLifetime = 3600 * 24 * 30 * 3, //3 month
                    AlwaysSendClientClaims = true,
                    AlwaysIncludeUserClaimsInIdToken = true,
                ...
                {
                    ClientId = "telegram",
                    ClientSecrets = {new Secret("oon8Iengi6auleiz".Sha256())},
                    ...
                    AllowedGrantTypes =
                    {
                        "delegation", GrantType.ResourceOwnerPassword
                    },
                    AllowAccessTokensViaBrowser = false,
