...
namespace Backend.Migrations
{
    ...
    [Migration("20210324095715_marketing1")]
    partial class marketing1
    {
            ...
            modelBuilder.Entity("CoreLib.Entitys.YmIdsConnection", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ym_ids_connection");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_ym_ids_connection_user_id");

                    b.HasIndex("YmIdId")
                        .HasDatabaseName("ix_ym_ids_connection_ym_id_id");

                    b.ToTable("ym_ids_connection");
                });
            ...
            modelBuilder.Entity("CoreLib.Entitys.YmIdsConnection", b =>
                {
                    b.HasOne("CoreLib.Entitys.UserDataParts.UserData", "User")
                        ...
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_ym_ids_connection_user_datas_user_id");

                    b.HasOne("CoreLib.Entitys.YmId", "YmId")
                        .WithMany()
                        .HasForeignKey("YmIdId")
                        .HasConstraintName("fk_ym_ids_connection_ym_ids_ym_id_id");
