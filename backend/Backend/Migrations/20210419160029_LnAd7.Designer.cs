...
namespace Backend.Migrations
{
    ...
    [Migration("20210419160029_LnAd7")]
    partial class LnAd7
    {
            ...
            modelBuilder.Entity("CoreLib.Entitys.LN.LnPaymentRequest", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ln_payment_request");

                    b.HasIndex("deal_fk")
                        .IsUnique()
                        .HasDatabaseName("ix_ln_payment_request_deal_fk");

                    b.HasIndex("owner_fk")
                        .HasDatabaseName("ix_ln_payment_request_owner_fk");

                    b.ToTable("ln_payment_request");
                });
            ...
            modelBuilder.Entity("CoreLib.Entitys.LN.LnPaymentRequest", b =>
                {
                    b.HasOne("CoreLib.Entitys.Deal", "Deal")
                        ...
                        .HasConstraintName("fk_ln_payment_request_deals_deal_fk");

                    b.HasOne("CoreLib.Entitys.UserDataParts.UserData", "Owner")
                        .WithMany("LNPaymentRequests")
                        .HasForeignKey("owner_fk")
                        .HasConstraintName("fk_ln_payment_request_user_datas_owner_fk")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
