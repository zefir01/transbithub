...
namespace Backend.Migrations
{
    ...
    [Migration("20210412121558_LnAd5")]
    partial class LnAd5
    {
            ...
            modelBuilder.Entity("CoreLib.Entitys.LN.LNPayment", b =>
                {
                    ...
                    b.Property<bool>("FeeFromBalance")
                        .HasColumnType("boolean")
                    ...
                    b.HasIndex("deal_fk")
                        .IsUnique()
                        .HasDatabaseName("ix_lnpayment_deal_fk");
            ...
            modelBuilder.Entity("CoreLib.Entitys.LN.LNPayment", b =>
                {
                    ...
                    b.HasOne("CoreLib.Entitys.Deal", "Deal")
                        .WithOne("WithdrawalLNPayment")
                        .HasForeignKey("CoreLib.Entitys.LN.LNPayment", "deal_fk")
                        .HasConstraintName("fk_lnpayment_deals_deal_fk");
            ...
            modelBuilder.Entity("CoreLib.Entitys.Deal", b =>
                {
                    ...
                    b.Navigation("WithdrawalLNPayment");
                });
