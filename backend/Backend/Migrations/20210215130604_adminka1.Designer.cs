...
namespace Backend.Migrations
{
    ...
    [Migration("20210215130604_adminka1")]
    partial class adminka1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreLib.Entitys.Dispute", b =>
                {
                    b.Property<long>("JiraIssueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("jira_issue_id")
                        .UseIdentityByDefaultColumn();

                    b.Property<long?>("ArbitorId")
                        .HasColumnType("bigint")
                        .HasColumnName("arbitor_id");
                    ...
                    b.HasIndex("ArbitorId")
                        .HasDatabaseName("ix_disputes_arbitor_id");
            ...
            modelBuilder.Entity("CoreLib.Entitys.Image", b =>
                {
                    ...
                    b.Property<string>("JiraFileName")
                        .HasColumnType("text")
                        .HasColumnName("jira_file_name");

                    b.Property<long>("JiraId")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("JiraId")
                        .HasDatabaseName("ix_images_jira_id");
            ...
            modelBuilder.Entity("CoreLib.Entitys.LN.LNPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_lnpayment");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_lnpayment_owner_id");
            ...
            modelBuilder.Entity("CoreLib.Entitys.Dispute", b =>
                {
                    b.HasOne("CoreLib.Entitys.UserDataParts.UserData", "Arbitor")
                        .WithMany()
                        .HasForeignKey("ArbitorId")
                        .HasConstraintName("fk_disputes_user_datas_arbitor_id");
            ...
            modelBuilder.Entity("CoreLib.Entitys.LN.LNPayment", b =>
                {
                    b.HasOne("CoreLib.Entitys.UserDataParts.UserData", "Owner")
                        .WithMany("LNPayments")
                        .HasForeignKey("OwnerId")
                        .HasConstraintName("fk_lnpayment_user_datas_owner_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoreLib.Entitys.UserDataParts.UserData", b =>
                {
                    ...
                    b.OwnsOne("CoreLib.Entitys.UserDataParts.UserData+JiraCredsClass", "JiraCreds", b1 =>
                        {
                            b1.Property<long>("UserDataId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                                .HasColumnName("id")
                                .UseIdentityByDefaultColumn();
                            ...
                            b1.Property<string>("Key")
                                .HasColumnType("text")
                                .HasColumnName("jira_creds_key");

                            b1.Property<string>("Password")
                                .HasColumnType("text")
                                .HasColumnName("jira_creds_password");

                            b1.Property<string>("Username")
                                .HasColumnType("text")
                                .HasColumnName("jira_creds_username");

                            b1.HasKey("UserDataId")
                                .HasName("pk_user_datas");

                            b1.HasIndex("Key")
                                .HasDatabaseName("ix_user_datas_jira_creds_key");
