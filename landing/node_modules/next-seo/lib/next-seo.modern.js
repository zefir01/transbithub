...
const buildTags = config => {
  ...
  if ((_config$additionalLin = config.additionalLinkTags) != null && _config$additionalLin.length) {
    config.additionalLinkTags.forEach(tag => {
      ...
      tagsToRender.push(React.createElement("link", Object.assign({
...
const buildAggregateRating$2 = aggregateRating => `
  "aggregateRating": {
      "@type": "AggregateRating",
      ${aggregateRating.ratingCount ? `"ratingCount": "${aggregateRating.ratingCount}",` : ''}
      ${aggregateRating.reviewCount ? `"reviewCount": "${aggregateRating.reviewCount}",` : ''}
...
export { ArticleJsonLd, BlogJsonLd, BreadCrumbJsonLd as BreadcrumbJsonLd, CarouselJsonLd, CollectionPageJsonLd, CorporateContactJsonLd, CourseJsonLd, DatasetJsonLd, defaultSEO as DefaultSeo, EventJsonLd, FAQPageJsonLd, JobPostingJsonLd, LocalBusinessJsonLd, LogoJsonLd, NewsArticleJsonLd, nextSEO as NextSeo, ProductJsonLd, ProfilePageJsonLd, QAPageJsonLd as QAPageJsonld, RecipeJsonLd, SiteLinksSearchBoxJsonLd, SocialProfileJsonLd, SoftwareAppJsonLd, VideoJsonLd };
