...
import {data, IStrings} from "../../localization/Helper/BuyCrypto/DealDisputed";
...
export function DealDisputed() {
    ...
    useEffect(() => {
        ...
        dispatch(SetCurrentPath("/helper/dealDisputed"));
    ...
    return (
        <>
            ...
            <Row className="pt-3 justify-content-center">
                <Col className="col-auto">
                    <h4 className="text-danger text-center">{strings.disputeCreated}</h4>
                    {strings.info}
                    <br/>
