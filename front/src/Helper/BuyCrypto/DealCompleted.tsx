...
import {data, IStrings} from "../../localization/Helper/BuyCrypto/DealCompleted";
...
export function DealCompleted() {
    ...
    useEffect(() => {
        ...
        dispatch(SetCurrentPath("/helper/dealCompleted"));
    ...
    return (
        <>
            ...
            <Row className="pt-3 justify-content-center">
                <Col className="col-auto">
                    <h4 className="text-success text-center">{strings.dealCompleted}</h4>
                    {deal.nowithdrawal ? strings.toBalance : null}
                    {!deal.nowithdrawal && deal.promisewithdrawal !== "" ?
                        <Card>
                            <CardBody>
                                <CardTitle>
                                    <h5>{strings.promise}</h5>
                                </CardTitle>
                                <MultilineContent text={deal.promisewithdrawal} small={true}/>
                            </CardBody>
                        </Card>
                        : null
                    }
                    {!deal.nowithdrawal && deal.bitcoinwithdrawal ?
                        <Card>
                            <CardTitle>
                                <h5>{strings.toWallet}</h5>
                            </CardTitle>
                            <span className="text-center font-italic">{deal.bitcoinwithdrawal}</span>
                        </Card>
                        : null
                    }
            ...
            <Row className="justify-content-center pt-3">
                <Col {...Col6_12}>
                    <DealFeedback deal={deal} title={strings.ph}/>
                </Col>
            </Row>
            <Row className="justify-content-center pt-3">
                <Col {...Col6_12}>
