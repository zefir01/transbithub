...
import {getToken, tradeApiClient, TradeGrpcRunAsync} from "./helpers";
        ...
        async function f() {
            try {
                ...
                for (let img of images.toUpload) {
                    ...
                    try {
                        let resp = await TradeGrpcRunAsync<Image>(tradeApiClient.storeImage, req, getToken(), false);
    ...
    useEffect(() => {
        ...
        async function f() {
            ...
            for (let img of images.toDownload) {
                ...
                TradeGrpcRunAsync<Image>(tradeApiClient.getImage, req, getToken(), false).then(resp => {
                    let url;
